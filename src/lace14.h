...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12, ATYPE_13);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12, ATYPE_13);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
RTYPE NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12, ATYPE_13, ATYPE_14);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
...
static_assert(sizeof(TD_##NAME) <= sizeof(Task), "TD_" #NAME " is too large, set LACE_TASKSIZE to a higher value!");\
                                                                                      \
void NAME##_CALL(LaceWorker*, ATYPE_1, ATYPE_2, ATYPE_3, ATYPE_4, ATYPE_5, ATYPE_6, ATYPE_7, ATYPE_8, ATYPE_9, ATYPE_10, ATYPE_11, ATYPE_12, ATYPE_13, ATYPE_14);\
                                                                                      \
static void NAME##_WRAP(LaceWorker* lace_worker, TD_##NAME *t __attribute__((unused)))\
{                                                                                     \
