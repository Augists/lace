...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5);                                      \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6);                               \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7);                        \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8);                 \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9);          \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10);  \
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, arg_11);\
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, arg_11, arg_12);\
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, arg_11, arg_12, arg_13);\
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
...
{                                                                                     \
    if (lace_is_worker()) {                                                           \
        NAME(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, arg_11, arg_12, arg_13, arg_14);\
    }                                                                                 \
    Task _t;                                                                          \
    TD_##NAME *t = (TD_##NAME *)&_t;                                                  \
    t->f = &NAME##_WRAP;                                                              \
